...
import { moveList } from '../../services/board'
...
import useStyles from '../../common/dialogStyles'
...
const MoveList = ({ listId, closeMenu }) => {
	...
	return (
		<Fragment>
			<div onClick={() => setOpenDialog(true)}>Przenieś listę</div>
			<Dialog open={openDialog} onClose={() => setOpenDialog(false)}>
				<div className={classes.moveListTop}>
					<DialogTitle>{'Przenieś listę'}</DialogTitle>
